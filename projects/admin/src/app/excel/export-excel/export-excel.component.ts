...
import { COL, CUSTOMER_COL, EXPENSES_COL, EXTRA_CUSTOMER_IN, EXTRA_CUSTOMER_OUT, FINANCIAL_COL, FINANCIAL_COL_in, FINANCIAL_COL_out, MAP, MAP_end, MAP_start, PRODUCTS_COL, TRANSACTION_ID_TO_NATURE } from '../../../../../common/excel/excel.interface';
...
export class ExportExcelComponent {
  ...
  create_HeaderRow() {
    ...
    // const financial_fill: ExcelJS.FillPattern = {
    //   type: "pattern",
    //   pattern: "solid",
    //   fgColor: { argb: "9BC2E6" } // Standard green
    // };
