...
export const balance_sheet_accounts: Account_def[] = [
    ...
    { key: BALANCE_SHEET_ACCOUNT.BAL_debit, label: 'BAL_debit', description: 'report année N-1' },
]
...
export type Transaction = {
    ...
    financial_accounts_to_charge: Array<FINANCIAL_ACCOUNT | CUSTOMER_ACCOUNT | BALANCE_SHEET_ACCOUNT>,
    nominative: boolean,
...
export const TRANSACTIONS: { [key in ENTRY_TYPE]: Transaction } = {
    ...
    [ENTRY_TYPE.cheque_forwarding]: {
        ...
        financial_accounts_to_charge: [BALANCE_SHEET_ACCOUNT.BAL_debit, FINANCIAL_ACCOUNT.BANK_credit],
